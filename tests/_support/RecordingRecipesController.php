...
use Tahadudhiya\WebDoctor\controllers\RecipesController;

/**
 * The recipes controller with its flash messages captured rather than stored, for the reason
 * {@see RecordingIssuesController} gives. Everything else is the real controller.
 */
class RecordingRecipesController extends RecipesController
{
